...
$ovaev_map_address = get_post_meta( $post->ID , 'ovaev_map_address', true ) ? get_post_meta( $post->ID ,'ovaev_map_address', true ) : esc_html__('New York, NY, USA', 'ovaev') ;
$ovaev_map_lat     = get_post_meta( $post->ID , 'ovaev_map_lat', true ) ? get_post_meta( $post->ID ,'ovaev_map_lat', true ) : '-33.8688';
$ovaev_map_lng     = get_post_meta( $post->ID , 'ovaev_map_lng', true ) ? get_post_meta( $post->ID ,'ovaev_map_lng', true ) : '151.2195';
// echo "<pre>";
// var_dump($post->post_name); die;
// var_dump($google_api); die;
