...
class Ova_Register_Elementor {
	...
	private function register_widget() {
		...
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new ova_heading_page() );
		...
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new ova_icon_muzze() );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new ova_menu_page() );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new ova_muzze_according() );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new ova_info_image() );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new ova_info() );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new ova_social() );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new admission_price() );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new ova_price_table() );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new ova_info_icon() );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new ova_testimonial() );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new ova_circle_text() );
		...
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new ova_muzze_according_image() );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new ova_artist() );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new ova_location() );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new ova_image_muzze() );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new ova_open_time() );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new ova_open_contact() );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new ova_slider() );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new ova_exhibitions_creactive() );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new ova_exhibitions_slide() );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new ova_event_parallax() );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new ova_exhibition_parallax() );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new ova_collection_parallax() );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new ova_icon_landing_page() );


		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new ova_home_fullscreen() );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new ova_muzze_shop() );
	}
