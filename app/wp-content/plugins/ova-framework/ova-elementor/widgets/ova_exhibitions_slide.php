				...
				if (!empty($tabs)) : foreach ($tabs as $item) : 
					...
					<article class="item-exhibition " >
						<div class="content">
							...
							<h2 <?php echo $data_animate_title ?> class=" title <?php echo $data_animate_class_title ?>"  ><a class="second_font" href="<?php echo esc_attr($item['link']['url']) ?>"><?php echo esc_html($item['title']) ?></a></h2>
							<?php if ($item['date'] != "") : ?>
						...
						<div  class="media " style='<?php echo esc_attr($background_image) ?>'>
							<a <?php echo $data_animate_image ?> class="image-box <?php echo $data_animate_class_image ?>" href="<?php echo esc_attr($item['link']['url']) ?>" style="animation-duration: <?php echo $settings['animation_dur_image'] ?>ms; opacity: 1;<?php echo esc_attr($background_img) ?>">
