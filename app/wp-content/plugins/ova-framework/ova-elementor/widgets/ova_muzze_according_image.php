					...
					<div class="accor-muzze-content-image <?php echo esc_attr($class_active) ?>">
						...
						<div class="wp-content">
							<div class="thumb_image">
								<img src="<?php echo esc_url( $img_src[0] ); ?>" alt="<?php echo esc_attr($item['title']) ?>">
							</div>
							<div class="sub-content">
								...
								<div id="slide-<?php echo esc_attr($i) ?>" class="content " >
									...
									<?php if($item['text_button'] != "") : ?>
										<a class="button-text" href="<?php echo esc_attr($item['link']['url']) ?>"><?php echo esc_html($item['text_button']) ?></a>
									<?php endif ?>
								</div>
							</div>
							<!-- end sub-content -->
