...
class ovaframework_hooks {
	...
	public function muzze_content_social( $link, $title ) {
 		$html = '<ul class="share-social-icons clearfix">
				...
				<li><a class="share-ico ico-twitter" target="_blank" href="https://twitter.com/share?url='.$link.'">'.esc_html__("Twitter", "muzze").'</a></li>

				<li><a class="share-ico ico-facebook" target="_blank" href="http://www.facebook.com/sharer.php?u='.$link.'">'.esc_html__("Facebook", "muzze").'</a></li>

				<li><a class="share-ico ico-pinterest" target="_blank" href="http://www.pinterest.com/pin/create/button/?url='.$link.'">'.esc_html__("Pinterest", "muzze").'</a></li>

				<li><a class="share-ico ico-mail" target="_blank" href="mailto:?body='.$link.'">'.esc_html__("Email", "muzze").'</a></li>
			
				<li><a class="share-ico ico-copy-url" data-url = "'.$link.'" id="ova-copy-link">'.esc_html__("Copy Url", "muzze").'</a></li>
